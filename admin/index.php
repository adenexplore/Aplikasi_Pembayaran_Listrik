            ...
            if ($num > 0) {
                ...
                echo "
                    <script>
                        ...
                        document.location.href = 'cek/dashboard.php';
                    </script>
                    ";
            } else {
                echo "
...
<body>
    ...
    <div class="count">
        <h1><img src="images/listrik.png" alt="ini logo">ADMIN LOGIN</h1>
            <form method="post">
                ...
                <button class="btn-regis"><a href="regist/register.php" style="text-decoration: none;color:white;"> REGISTER</a></button>
                </div>
            </form>
    </div>
</body>
